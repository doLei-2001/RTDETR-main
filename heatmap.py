...
def get_params():
    params = {
        # 'weight': '/home/public/leiao23/code/RTDETR-main/weights/rtdetr-x.pt',
        'weight': '/home/public/wuan23/yolo11n/run_bddk/yolo11_bddk/weights/best.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    # model(r'/home/public/leiao23/code/datasets/dataset_visdrone/VisDrone2019-DET-val/images', 'result_soep')
    model(r'/home/public/wuan23/data/BDD100K/val/images', './heatmap/heatmap_bdd100k_yolo11baseline')