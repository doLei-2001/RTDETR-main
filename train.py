...
if __name__ == '__main__':
    # model = RTDETR('ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml') # 原始的r18模型
    model = RTDETR('/home/public/leiao23/code/RTDETR-main/weights/rtdetr-r18.pt')
    # model.load('') # loading pretrain weights 预训练权重


    # model.train(data='/home/public/leiao23/code/datasets/dataset_visdrone/data.yaml', # visdrone数据集
    # model.train(data='/home/public/wuan23/yolo11/myTest/data_bdd100k.yaml', # visdrone数据集
    model.train(data='/home/public/wuan23/yolo11/myTest/data_kitti.yaml', # visdrone数据集
                cache=False,
                imgsz=640,
                epochs=250,
                ...
                # resume='', # last.pt path
                project='runs/train',
                name='exp-rtdetr-kitti-250epoch-rtdetr-r18',
                )