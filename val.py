...
if __name__ == '__main__':
    # model_path = 'runs/train/rtdetr-SRFD-SOEP-MFM-DRBC3-Pola-SEFN-Mona-DIMB/weights/best.pt'
    model_path = 'runs/train/exp-rtdetr-300epoch-r18-bdd100k/weights/best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    # result = model.val(data='/home/public/leiao23/code/datasets/dataset_visdrone/data.yaml',
    result = model.val(data='/home/public/wuan23/yolo11/myTest/data_bdd100k.yaml',
